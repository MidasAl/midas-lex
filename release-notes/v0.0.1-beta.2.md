...
Added automatic wrapper and runtime update checks. On Windows, Midas Lex now asks users to reinstall with `cargo install midas-lex --force` when a newer wrapper is available.
